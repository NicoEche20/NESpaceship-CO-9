...
from game.utils.constants import HEART_TYPE, PLAYER_TYPE, SCREEN_HEIGHT, SCREEN_WIDTH, SHIELD_TYPE, SPACESHIP, DEFAULT_TYPE
...
class Spaceship(Sprite):
    ...
    def power_up_select(self,image):
